...
public class SequenceObjectMover1 : MonoBehaviour
{
        ...
        if (!implementation.activeSelf){
            if(!touchPoint.isLast){
                if (!hasMoved1 & touchPoint.id == 1)
                    { 
                    ...
                    } else if (!hasMoved4 & touchPoint.id == 4){
                         objectToMove4.SetActive(true);
                        ...
                        float z = objectToMove4.transform.localPosition.z;
                        
                        Vector3 touchPosition = new Vector3(coord.Item1, coord.Item2, z);

                        // Déplacer l'objet à l'emplacement de l'entrée tactile
                        objectToMove4.transform.localPosition = touchPosition;
